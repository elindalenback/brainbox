...
## Table of Contents
  ...
  * [Future Features](#future-features)
    + [Notebook Organization (In Progress)](#notebook-organization--in-progress-)
    + [Dark Mode](#dark-mode)
    + [Note Versioning](#note-versioning)
    + [Collaboration](#collaboration)
    + [Export Notes](#export-notes)
    + [Import Notes](#import-notes)
    + [Notification Preferences](#notification-preferences)
    + [Share Notes](#share-notes)
      - [Restrict Poll Creation to Admin Users:](#restrict-poll-creation-to-admin-users-)
